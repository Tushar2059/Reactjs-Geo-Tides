                ...
                {currentQuestion.questionType === "selectOptions" ? (
                  <Fragment>
                    ...
                    <div className="options-container">
                      ...
                      {/* Start Button with images ... 
                      <button
                        onClick={this.handleOptionClick}
                        disabled={questionTwiceWrongAttempt ? true : false}
                        className="option-with-img"
                        id="option-a"
                        style={(this.state.changeBackColor[0]) ? {backgroundColor:"red"} : {borderColor:"rgba(75, 75, 177, 0.808)"}}
                      > <div className="optionText"> A. {parse(currentQuestion.optionA)} </div> <img src={require(`../../Img/OptionImg/${currentQuestion.optionAImg}`)} width="60" /> </button>
                      ...
                      <button
                        ...
                        className="option-with-img"
                        id="option-c"
                        style={(this.state.changeBackColor[2]) ? {backgroundColor:"red"} : {borderColor:"rgba(75, 75, 177, 0.808)"}}
                      > <div className="optionText"> C. {parse(currentQuestion.optionC)} </div> <img src={require('../../Img/OptionImg/abc.jpg')} width="60" /> </button>
